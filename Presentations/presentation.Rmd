...
- It is a concern that politicians use public office to serve private interests. They can do so in various ways:
...
- Many aspects of the political system changed: 
  ...
  - Suffrage extensions and universal suffrage (Przeworski, 2009)
...
- I firstly replicate findings from the contemporary literature
...
- _Repositorium_:
  - Newspaper recommendations of each candidate, turnout, no. of times participated, year of election
  - Used to extract several election- and candidate characteristics
...
- Rewards: staying longer in politics
...
## Flexible Optimal Bandwidth - Suffrage Extensions
